...
class WidgetParagraph extends WidgetInputBase {
    constructor(fragment) {
        super(constants.WIDGET_TYPE_PARAGRAPH, fragment);
        this._minLength = 0;
        this._maxLength = 0;
    ...
    async getPropertiesEditorTemplate() {
        var props = await this._getPropertiesEditorTemplateCore("widget-paragraph", "WidgetParagraphPropertiesEditor");
    ...
    refresh() {
        ...
        super.refresh();
        var inputs = this._el.querySelectorAll("textarea");
        if (inputs.length) {
    ...
    async render(container, parser) {
        ...
        var replacements = {
            ...
            id: this.id,
            inputClass: this.globalClasses.textarea ?? "",
        ...
        var html = await super._loadWidgetTemplate("widget-paragraph", replacements);
